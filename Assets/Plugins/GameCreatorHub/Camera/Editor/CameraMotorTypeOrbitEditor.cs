namespace GameCreator.Camera
{
    ...
    [CustomEditor(typeof(CameraMotorTypeOrbit))]
	public class CameraMotorTypeOrbitEditor : ICameraMotorTypeEditor 
	{
		...
		private const string PROP_INITIAL_PITCH = "initialPitch";
		private const string PROP_PITCH_LIMITS = "pitchLimits";
		...
		private SerializedProperty spInitialPitch;
        private SerializedProperty spPitchLimits;
        ...
        protected override void OnSubEnable()
		{
            ...
            this.spInitialPitch = serializedObject.FindProperty(PROP_INITIAL_PITCH);
			this.spPitchLimits = serializedObject.FindProperty(PROP_PITCH_LIMITS);
		...
		protected override bool OnSubInspectorGUI (Transform cameraMotorTransform)
		{
			...
			EditorGUILayout.PropertyField(this.spInitialPitch);
			EditorGUILayout.PropertyField(this.spPitchLimits); 
			
			float plimitX = this.spPitchLimits.vector2Value.x;
            float plimitY = this.spPitchLimits.vector2Value.y;
			EditorGUILayout.MinMaxSlider("Pitch Limits", ref plimitX, ref plimitY, -70f, 70f);
            this.spPitchLimits.vector2Value = new Vector2(plimitX, plimitY);
        ...
        public override bool OnSubSceneGUI(Transform cameraMotorTransform)
        {
            ...
            float angle = this.spInitialPitch.floatValue;
