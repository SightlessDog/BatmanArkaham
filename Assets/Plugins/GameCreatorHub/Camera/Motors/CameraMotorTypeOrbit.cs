namespace GameCreator.Camera
{
    ...
    [AddComponentMenu("")]
    [System.Serializable]
    public class CameraMotorTypeOrbit : ICameraMotorType
    {
        ...
        public static new string NAME = "Orbit Camera";
        ...
        public OrbitInput orbitInput = OrbitInput.HoldRightMouse;
        public float orbitSpeed = 25.0f;
        private float orbitInputTime = -1000f;


        [Range(-70f, 70f)]public float initialPitch = 30f;
            ...
            if (targetGo != null)
            {
                ...
                switch (this.initialDirection)
                {
                    case InitDirection.TargetDirection:
                        ...
                        this.targetRotationY = targetTransform.rotation.eulerAngles.x - initialPitch;
                        break;

                    case InitDirection.MotorDirection:
                        this.targetRotationX = transform.rotation.eulerAngles.y + 180f;
                        this.targetRotationY = transform.rotation.eulerAngles.x - initialPitch;
                        break;
                    ...
                    case InitDirection.CameraDirection:
                        ...
                        this.targetRotationY = cam.rotation.eulerAngles.x - initialPitch;
                        break;
        ...
        private void RotationRecover()
        {
            ...
            float targetRecoverY = targetTransform.eulerAngles.x - initialPitch;
