namespace GameCreator.Melee
{
	...
	[AddComponentMenu("")]
	public class ConditionMeleeCompareDefense : ICondition
	{
        ...
        public static new string NAME = "Melee/Compare Defense";
		private const string NODE_TITLE = "Character {0} defense is {1} than {2}";
